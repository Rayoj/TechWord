...
```
  ...
  <Card>
    <div className="flex items-center gap-4 mb-4">
      <div className="bg-green-5000 p-2 rounded-full text-white">2</div>
      <h2 className="text-xl font-semibold">Credentials</h2>
    </div>

    <div className="space-y-2 flex flex-col items-center">
      <div className="get-key p-2 bg-green-500 dark:bg-gray-800 rounded-lg w-full flex justify-center">
        <a  
          href="https://www.themoviedb.org/login?to=read_me&redirect=%2Freference%2Fintro%2Fgetting-started" 
          rel="noopener noreferrer"
          className="px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green transition w-full text-center"
        >
  Get API Key
</a>
