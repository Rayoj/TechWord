...
┃  
┃ Navigate to API reference, [here](https://developer.themoviedb.org/reference/intro/authentication).   
┃  
...
┃  
┃ Paste your **API Key** into the **Authorization-header** to  set it.   
┃  
