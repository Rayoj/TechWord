...
- Movie Information in Spanish: Check this out! [here](https://api.themoviedb.org/3/movie/{movie_id}?language=es)

- TV Show Information in Italian:Check this out! [here](https://api.themoviedb.org/3/tv/{tv_id}?language=it)
